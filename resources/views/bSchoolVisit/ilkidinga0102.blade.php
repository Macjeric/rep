...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <!-- <link href="https://fonts.googleapis.com/css2?family=Open+Sans&display=swap" rel="stylesheet"> -->
           <style type="text/css">
                @font-face {
                    ...
                    src: url(/fonts/AdobeCleanUI-Regular.ttf) format("truetype");
                }
    ...
    <div class="contain">
        <div class="flex justify-center mt-4">   
            <img src="/imgs/ren.png" width="100" height="100">
        </div>

        <div class="flex justify-center">
            <h2 class="mt-1">
                Reaneal International Education Outreach Inc.
            </h2> 
        </div>
        ...
        <div>
                <table class="table-auto mt-5">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="border px-4 py-2">7. sudo reporter.py</td>
                      <td class="border px-4 py-2"><img src="/imgs/check.png" width="30" height="30"></td>
                      <!-- <td class="border px-4 py-2">1,280</td> -->
                    </tr>
                    <tr class="bg-gray-100">
                    ...
                    <tr>
                      <td class="border px-4 py-2">11. take the photo outside the lab</td>
                      <td class="border px-4 py-2"><img src="/imgs/check.png" width="30" height="30"></td>
                      <td class="border px-4 py-2">12:20</td>
                      <!-- <td class="border px-4 py-2">1,280</td> -->
                    </tr>
